...
class WavesDownloadModel(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]
    instrument_depth: Optional[float]
    station_name: Optional[str]
    water_depth: Optional[float]
    date_time: Optional[datetime]
    number_readings: Optional[float]
    record_length: Optional[float]
    deltaf: Optional[float]
    ...
    tp: Optional[float]
    tz: Optional[float]
    ave_direction: Optional[float]
    ave_spreading: Optional[float]
    instrument_code: Optional[float]
    mean_direction: Optional[float]
    mean_spreading: Optional[float]
